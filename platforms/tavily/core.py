"""Tavily Registration protocol core implementation (Auth0 process)"""
...
class TavilyRegister:
    ...
    def step4_submit_otp(self, otp: str, challenge_state: str) -> str:
        self.log("Submit verification code...")
        r = self.ex.post(
    ...
    def step6_resume_and_get_key(self, resume_state: str) -> str:
        self.log("Complete the authorization process...")
    ...
    def register(self, email: str, password: str,
        ...
        self.log(f"API Key: {api_key[:20]}..." if api_key else "Not obtained API Key")
